...
namespace Rij62.Migrations
{
    ...
    [Migration("20260608094414_multiPresets")]
    partial class multiPresets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MenuPresetProduct", b =>
                {
                    b.Property<int>("MenuPresetsId")
                        .HasColumnType("integer")
                        .HasColumnName("menu_presets_id");

                    b.Property<int>("ProductsId")
                        .HasColumnType("integer")
                        .HasColumnName("products_id");

                    b.HasKey("MenuPresetsId", "ProductsId")
                        .HasName("pk_menu_preset_product");

                    b.HasIndex("ProductsId")
                        .HasDatabaseName("ix_menu_preset_product_products_id");

                    b.ToTable("menu_preset_product", (string)null);
                });
            ...
            modelBuilder.Entity("Rij62.Models.MenuPresetLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_menu_preset_links");

                    b.HasIndex("MenuPresetId")
                        .HasDatabaseName("ix_menu_preset_links_menu_preset_id");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_menu_preset_links_product_id");

                    b.ToTable("menu_preset_links", (string)null);
                });
            ...
            modelBuilder.Entity("MenuPresetProduct", b =>
                {
                    b.HasOne("Rij62.Models.MenuPreset", null)
                        .WithMany()
                        .HasForeignKey("MenuPresetsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_menu_preset_product_menu_presets_menu_presets_id");

                    b.HasOne("Rij62.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_menu_preset_product_products_products_id");
                });

            modelBuilder.Entity("Rij62.Models.MenuPresetLink", b =>
                {
                    b.HasOne("Rij62.Models.MenuPreset", "MenuPreset")
                        .WithMany("Links")
                        .HasForeignKey("MenuPresetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_menu_preset_links_menu_presets_menu_preset_id");

                    b.HasOne("Rij62.Models.Product", null)
                        .WithMany("PresetLinks")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_menu_preset_links_products_product_id");

                    b.Navigation("MenuPreset");
                });
